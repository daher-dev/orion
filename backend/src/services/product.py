...
from models import Ad, PrintDesign, Product, ProductSpec, ProductVariation
...
async def delete_product(
    ...
    *,
    ...
    linked_ads = await db.exec(select(func.count()).select_from(Ad).where(Ad.product_id == product.id))
