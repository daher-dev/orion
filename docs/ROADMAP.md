...
| F-007 | Production: Cutting | in-progress | 3 | `feature/wave3-frontends` |
| F-008 | Production: Bancas (contractors) | in-progress | 1 | `feature/008-contractors` |
| F-009 | Production: Sewing (shipments) | in-progress | 3 | `feature/wave3-frontends` |
| F-010 | Inventory: Stock | planned | 4 | `feature/010-stock` |
| F-011 | Sales: Clients | in-progress | 1 | `feature/011-clients` |
| F-012 | Sales: Ads | in-progress | 3 | `feature/wave3-frontends` |
