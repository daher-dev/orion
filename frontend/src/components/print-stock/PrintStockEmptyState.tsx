...
export function PrintStockEmptyState({ onCreate }: Props) {
  const t = useTranslations("printStock.list.empty");
  return (
    <div
      data-testid="print-stock-empty-state"
    ...
    >
      ...
      {onCreate ? (
        <Button
          onClick={onCreate}
          data-testid="print-stock-empty-cta"
