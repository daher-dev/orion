...
down_revision: str | Sequence[str] | None = "52d3c18cd680"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            postgresql.ENUM("open", "adjusted", "printed", "done", "cancelled", name="batch_status"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["batch_id"], ["batches.id"], name=op.f("fk_batch_print_adjustments_batch_id_batches"), ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
        ...
        sa.UniqueConstraint(
            "batch_id", "print_design_id", "product_color", name="uq_batch_print_adjustments_design_color"
        ),
    )
    ...
    op.create_foreign_key(
        op.f("fk_orders_batch_id_batches"), "orders", "batches", ["batch_id"], ["id"], ondelete="SET NULL"
    )
